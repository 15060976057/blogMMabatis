...
<%} %>
    ...
    <div id="nav">
      <ul class="nav">
        ...
        <li><a href="${pageContext.request.contextPath }/js.jsp">发布博客</a></li>
        ...
        <li><input class="no_border" type="submit" value="励志"/></li>
        </form>
         <form action="Article.do" method="post">
        <input type="hidden" name="method" value="display">
        
         <input type="hidden" name="ACategory" value="雅思">
        <li><input class="no_border" type="submit" value="雅思"/></li>
        </form>
       ...
       <dl>
           ...
           <dd class="txt2">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
           			不论你的学习英语是为了满足日常沟通需要，还是为了工作和职业的发展，不论你现在的英语水平处在哪个阶段，
				           ...
				           从入门带精通的9个级别的英语晋升阶梯，让你的学习成为轻松、快乐的旅程！
				           高雅、舒适的学习环境，为您提供一个高端人士社交的平台。</dd>
        </dl>
    ...
    <div class="list1">
		     ...
		     <table class="content">
			               <tr>
			                   ...
			                   <td><input type="text" class="txt01" name="userName" placeholder="请输入用户名"/></td>
			               </tr>
			               
			               <tr>
			                   <td class="left">密码:</td>
			                   <td><input type="password" class="txt01" name="password" placeholder="请输入密码"/></td>
			               </tr>
	          ...
	          <a href="${pageContext.request.contextPath}/Register.jsp"><img style="margin-top:40px" src="images/register.jpg"></img></a>
        </div>
    </div>
    <div class="footer">INVINCIBLE &nbsp;&nbsp;版权所有 &nbsp;&nbsp;2000-2021 &nbsp;&nbsp;泉州信息工程学院 &nbsp;&nbsp;青春小队</div>
</body>
</html>